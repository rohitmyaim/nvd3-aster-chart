nv.models.aster = function() {
  ...
  var margin = {top: 0, right: 0, bottom: 0, left: 0}
    ...
    , getHeight = function(d) { return d.x/d.y*100;}
    ...
    , endAngle = false
    , donutRatio = 0.5
    , labelText = function(d) { return d.x + " of " + d.y; }
  ...
  function chart(selection) {
    selection.each(function(data) {
      ...
      var percent = function(d) {
        return  d3.format('.2%')((d.endAngle - d.startAngle) / (2 * Math.PI));
      }
      var arc = d3.svg.arc()
...
//            .attrTween('d', arcTween);
        ...
        d3.transition(slices.select('.outlineArc'))
            .attr('d', outlineArc)
//            .attrTween('d', arcTween);
            ...
            slice
              .select(".nv-label text")
                ...
                .text(function(d, i) {
                  ...
                  var labelTypes = {
                    "custom" : labelText(d.data),
                    "key" : getX(d.data),
                    "value": getY(d.data),
                    "percent": d3.format('.2%')(percent)
                  };
